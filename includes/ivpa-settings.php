	...
	class WC_Ivpa_Settings {
		...
		public static function get_settings() {
			...
			$plugins['improved_options'] = array(
				...
				'sections' => array(
					'dashboard' => array(
						'name' => esc_html__( 'Dashboard', 'ivpawoo' ),
						'desc' => esc_html__( 'Dashboard Overview', 'ivpawoo' ),
					),
					'options' => array(
				...
				'settings' => array(
					...
					'wcmn_dashboard' => array(
						...
						'id' => 'wcmn_dashboard',
						'desc' => '
						<img src="' . Wcmnivpa()->plugin_url() . '/assets/images/improved-product-options-for-woocommerce-shop.png" class="svx-dashboard-image" />
					...
					'wcmn_utility' => array(
						'name' => esc_html__( 'Plugin Options', 'ivpawoo' ),
						'type' => 'utility',
						'id' => 'wcmn_utility',
						'desc' => esc_html__( 'Quick export/import, backup and restore, or just reset your optons here', 'ivpawoo' ),
						'section' => 'dashboard',
					),
					...
					'wc_ivpa_attribute_customization' => array(
						...
						'autoload' => false,
						'section' => 'options',
						//'title' => esc_html__( 'Option', 'ivpawoo' ),
						'supports' => array( 'customizer' ),
						'options' => 'list',
						'translate' => true,
						'selects' => array(
							'ivpa_attr' => esc_html__( 'Attribute Swatch', 'ivpawoo' ),
							'ivpa_custom' => esc_html__( 'Custom Option', 'ivpawoo' )
						),
						'settings' => array(
							'ivpa_attr' => array(
								'taxonomy' => array(
					...
					'wc_settings_ivpa_single_prices' => array(
						'name' => esc_html__( 'Price Total', 'ivpawoo' ),
						'type' => 'select',
						'desc' => esc_html__( 'Select price to use for product options cost total.', 'ivpawoo' ),
						'id'   => 'wc_settings_ivpa_single_prices',
						'options' => array(
							'disable' => esc_html__( 'Disable', 'ivpawoo' ),
							'summary' => esc_html__( 'Use all product summary prices', 'ivpawoo' ),
							'form' => esc_html__( 'Use only varable price (Only Variable Products have this)', 'ivpawoo' ),
							'plugin' => esc_html__( 'Add product price to top of product option', 'ivpawoo' ),
							'plugin-bottom' => esc_html__( 'Add product price to bottom of product options', 'ivpawoo' ),
						),
						'default' => 'summary',
						'autoload' => false,
						'section' => 'product'
					...
					'wc_settings_ivpa_archive_prices' => array(
						...
						'options' => array(
							'disable' => esc_html__( 'Disable', 'ivpawoo' ),
							'product' => esc_html__( 'Use product price', 'ivpawoo' ),
							'plugin' => esc_html__( 'Add product price to top of product options', 'ivpawoo' ),
							'plugin-bottom' => esc_html__( 'Add product price to bottom of product options', 'ivpawoo' ),
						),
						'default' => 'product',
						'autoload' => false,
